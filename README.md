...
- Press Save to Save the recorded actions as a preset for future use.
...
- Playback Controls: Start, pause, dealy between commands and loop playback of recorded actions.
